export default function mediaFactory(data) {
  ...
  //   article.innerHTML = `<a tabindex="9" alt="${title}, closeup view"
  // href="#" onclick="displayLightboxModal(${id})" >
  //       ${media}
  //     </a>
  //     <div>
  //       <p tabindex="9">${title}</p>
  //       <div tabindex="9" class="likes-${id}" ><p class="likesData">${likes}
  // </p><button class="button-likes-${id}">
